...
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=500 --nodes=20 --CSVfileName=bsm_20node_cvgauss.output.csv --CSVfileName2=bsm_20node_cvgauss.output2.csv --CSVfileName3=bsm_20node_cvgauss.output3.csv" > trace_20n.log 2> bsm_20n.log
#echo "//#define ADAPTIVE_PRIO" > "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=500 --nodes=20 --pcap=0 --CSVfileName=bsm_control_20node_cvgauss.output.csv --CSVfileName2=bsm_control_20node_cvgauss.output2.csv --CSVfileName3=bsm_control_20node_cvgauss.output3.csv" > trace_c20n.log 2> bsm_c20n.log
...
#echo "#define ADAPTIVE_PRIO" > "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=500 --nodes=40 --CSVfileName=bsm_40node_cvgauss.output.csv --CSVfileName2=bsm_40node_cvgauss.output2.csv --CSVfileName3=bsm_40node_cvgauss.output3.csv" > trace_40n.log 2> bsm_40n.log
#echo "//#define ADAPTIVE_PRIO" > "src/wave/model/adaptive_priotag.h"
#NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=500 --nodes=40 --pcap=0 --CSVfileName=bsm_control_40node_cvgauss.output.csv --CSVfileName2=bsm_control_40node_cvgauss.output2.csv --CSVfileName3=bsm_control_40node_cvgauss.output3.csv" > trace_c40n.log 2> bsm_c40n.log
...
echo "#define PRIO_MANUEVER_THRESHOLD 4.90" >> "src/wave/model/adaptive_priotag.h"
