...
echo "#define ADAPTIVE_PRIO" > "src/wave/model/adaptive_priotag.h"
NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=400 --nodes=160 --CSVfileName=bsm_160node_cvgauss.output.csv --CSVfileName2=bsm_160node_cvgauss.output2.csv --CSVfileName3=bsm_160node_cvgauss.output3.csv" > trace_160n.log 2> bsm_160n.log
echo "about to go into 160 node control"
echo "//#define ADAPTIVE_PRIO" > "src/wave/model/adaptive_priotag.h"
NS_GLOBAL_VALUE="RngRun=$5" ./waf --run "scratch/wave-bsm-risk_cvgauss --protocol=0 --totaltime=400 --nodes=160 --pcap=0 --CSVfileName=bsm_control_160node_cvgauss.output.csv --CSVfileName2=bsm_control_160node_cvgauss.output2.csv --CSVfileName3=bsm_control_160node_cvgauss.output3.csv"> trace_c160n.log 2> bsm_c160n.log
